...
function cancelReply(token) {
    SqueezeBox.close();
    var delReq = new Ajax('<?php echo $this->delAttLink; ?>' + '&formtoken=' + token, {method:'get'}).request();
}
 -->
</script>
...
<tr>
<td class="otrs-ticket-status-col1"><b><?php echo JText::_('OTRS_CREATED'); ?>:</b> <?php echo htmlspecialchars($this->ticket->Created); ?></td>
<td><b><?php echo JText::_('OTRS_UPDATED');?>:</b> <?php echo htmlspecialchars($this->ticket->Changed); ?></td></tr>
<tr>
<td class="otrs-ticket-status-col1"><b><?php echo JText::_('OTRS_STATE');?>:</b> <?php echo htmlspecialchars($this->ticket->State); ?></td>
<td><b><?php echo JText::_('OTRS_PRIORITY');?>:</b> <?php echo htmlspecialchars($this->ticket->Priority); ?></td></tr>
<tr>
<td colspan="2">
<b><?php echo JText::_('OTRS_FROM');?>:</b> <?php echo htmlspecialchars($this->ticket->Main->From); ?></td></tr>
<tr>
<td colspan="2">
<b><?php echo JText::_('OTRS_QUEUE');?>:</b> <?php echo htmlspecialchars($this->ticket->Queue); ?></td>
</tr>
</table>

<div id="otrs-ticket-top-reply">
<a class="modal button" href="index.php?option=com_otrsgateway&task=replyForm&ticketID=<?php echo $this->ticket->TicketID; ?>" rel="{handler:'iframe',size:{x:650,y:450},ajaxOptions:{}}"><?php echo JText::_('OTRS_REPLY');?></a>
</div>
</div></div></div>
...
<span><b><?php echo JText::_('OTRS_ATTACHMENTS'); ?>:</b></span><br />
<?php
...
<h2><?php echo JText::_('OTRS_DESCRIPTION'); ?></h2>
