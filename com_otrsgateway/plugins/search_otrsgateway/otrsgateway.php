...
$mainframe->registerEvent( 'onSearch', 'plgSearchOTRSGateway' );
$mainframe->registerEvent( 'onSearchAreas', 'plgSearchOTRSGatewayAreas' );
 ...
 */
function &plgSearchOTRSGatewayAreas()
{
	static $areas = array(
		'otrsgateway' => 'Tickets'
	);
