...
require_once( JPATH_SITE.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_otrsgateway'.DIRECTORY_SEPARATOR.'helpers'.DIRECTORY_SEPARATOR.'rpchelper.php' );
...
class OTRSGatewayUserHelper
{
    ...
    function getOTRSUserData()
    {
        ...
        $params = $app->getParams( 'com_otrsgateway' );
        $vars = null;
