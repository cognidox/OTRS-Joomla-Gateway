...
class plgSearchOTRSGateway extends JPlugin
{
    ...
    */
    ...
    function onContentSearch( $text, $phrase='', $ordering='', $areas=null )
    {
        ...
        include_once( JPATH_SITE . DIRECTORY_SEPARATOR . "administrator" . DIRECTORY_SEPARATOR ."components" . DIRECTORY_SEPARATOR . 
                      "com_otrsgateway" . DIRECTORY_SEPARATOR . "helpers" . DIRECTORY_SEPARATOR . "rpchelper.php" );
        include_once( JPATH_SITE . DIRECTORY_SEPARATOR . "components" . DIRECTORY_SEPARATOR . 
                      "com_otrsgateway" . DIRECTORY_SEPARATOR . "helpers" . DIRECTORY_SEPARATOR . "userhelper.php" );
